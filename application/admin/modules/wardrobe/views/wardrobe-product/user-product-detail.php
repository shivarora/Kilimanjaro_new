...
<style>
    ...
    */
    ...
    input#qty, button#qty, select#qty, textarea#qty {
                            ...
                            <ul class="breadcrumbs">
                                ...
                                <div class="breadcrumbs-content">
                                    ...
                                    <li class="product last" itemscope="" itemtype="">
                                        ...
                                        <?= ucfirst($product_main_details['product_name']); ?>
                ...
                <div class="col-md-7">
                    ...
                    <div class="right-wardrob-prodt-shop-container">
                        ...
                        <div class="wardrob-prodt-name">
                            ...
                            <h1> <?= ucfirst($product_main_details['product_name']); ?> </h1>
                        ...
                        <div class="wardrob-prodt-price-box">
                            ...
                            <div class="wardrob-prodt-special-price">
                                ...
                                <div class="wardrob-prodt-special-price">
                                    ...
                                    <div class="wardrob-prodt-price">$<?= $product_main_details['product_price']; ?></div>
                        ...
                        <div class="prodt-count-container">
                            ...
                            $hidden['simple'] = $isSimple;

                            $hidden['category_dept'] = $deptId;

                            $hidden['product_id'] = $product_main_details['product_id'];

                            $hidden['product_sku'] = $product_main_details['product_sku'];
                            ...
                            if ($userAssignments && is_array($userAssignments) && isset($userAssignments[0]['quantity']) && $userAssignments[0]['quantity']) {
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input  type="number" name="qty" id="qty"
                                            ...
                                            value="<?= $qty_range_start; ?>" 

                                            min="<?= $qty_range_start; ?>" 

                                            max="<?= $qty_range_last; ?>" style="-moz-appearance:textfield;">
    ...
    ?>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <small>Policy days: <?= $assignedDay; ?></small>

                                    </div>

                                    <div class="col-md-3">

                                        <small>Policy qty.: <?= $assignedQty; ?></small>

                                    </div>

                                    <div class="col-md-3">

                                        <small>Left qty.: <?= $qty_range_last; ?></small>
...
if (isset($product_attr_details[$product_main_details['product_id']]['prdAttrLblOpts'])) {
    ...
    if (isset($product_attr_details[$product_main_details['product_id']]
        ...
        $fConfigAttr = $product_attr_details[$product_main_details['product_id']]['attrbSetattrConf'][0];

    }

    foreach ($product_attr_details[$product_main_details['product_id']]['prdAttrLblOpts']
...
?>
                        ...
                        <div class="short-description">
                            ...
                            <p><?= $product_main_details['product_description']; ?></p>
    ...
    jQuery(document).ready(function ($) {
        ...
        $("#add-to-cart").submit(function (event) {
            ...
            if (selectedQt) {
                ...
                $('#comMsgModalTitle').html('Request quantity');
...
<script>
    ...
    $('.input-number').change(function () {
        ...
        if (valueCurrent >= minValue) {
            ...
            $('#comMsgModalBody').html('Sorry, the minimum value (' + minValue + ') has reached');
        ...
        if (valueCurrent <= maxValue) {
            ...
            $('#comMsgModalBody').html('Sorry, the maximum value (' + maxValue + ') has reached');
