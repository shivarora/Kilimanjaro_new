...
<div class="order-history-full-container">
    ...
    <?php
        ...
        echo form_open( 'request/ajax/request/approvals', 

                        ' id="request-search-form" name="request-search-form"', 
        ...
        <thead>
            ...
            <tr role="row">
                ...
                <th role="columnheader" tabindex="0" aria-controls="table" rowspan="1" colspan="1" style="width: 100px;" >
                    ...
                    <div class="allign-center" style="width:100%; float:left"> Request Date </div> 
