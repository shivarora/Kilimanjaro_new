...
class Common_auth_admin_model extends CI_Model {
	...
	function get_user_accounts() {
		...
		$sql_select = [
						...
						'uadd_alias', 'uadd_recipient', 'uadd_phone',
						'uadd_company','uadd_address_01','uadd_address_02',
						'uadd_city','uadd_county', 'uadd_post_code','uadd_country'
						];

		$this->flexi_auth->sql_select($sql_select);

		// For this example, prevent any 'Master Admin' users (User group id of 3)
		// being listed to non 'Master Admin' users.
...
/* End of file common_auth_admin_model.php */
/* Location: ./admin/models/common_auth_admin_model.php */