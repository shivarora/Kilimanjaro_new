...
*/
	...
	*/ 
	$config['database']['user_acc']['table'] = $config['database']['dbprefix'].'user_accounts';
	$config['database']['user_acc']['join'] = $config['database']['dbprefix'].'user_accounts.uacc_id';
	 ...
	 * All columns are required.
	*/ 
	$config['database']['user_group']['table'] = $config['database']['dbprefix'].'user_groups';
	$config['database']['user_group']['join'] = $config['database']['dbprefix'].'user_groups.ugrp_id';
	...
	$config['database']['user_acc']['custom_columns'] = array(
		'ugrp_fully_approved','ugrp_order','ugrp_aprrove_from',
	);
	###++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++###
	 ...
	 * All columns are required.
	*/ 
	$config['database']['user_privileges']['table'] = $config['database']['dbprefix'].'user_privileges';
	 ...
	 * All columns are required.
	*/ 
	$config['database']['user_privilege_users']['table'] = $config['database']['dbprefix'].'user_privilege_users';
	 ...
	 * All columns are required.
	*/ 
	$config['database']['user_privilege_groups']['table'] = $config['database']['dbprefix'].'user_privilege_groups';
	 ...
	 * All columns are required.
	*/ 
	$config['database']['user_sess']['table'] = $config['database']['dbprefix'].'user_login_sessions';
	$config['database']['user_sess']['join'] = $config['database']['dbprefix'].'user_login_sessions.usess_uacc_fk';
	...
	*/ 
	$config['database']['custom']['user_profile']['table'] = $config['database']['dbprefix'].'user_profiles';
	$config['database']['custom']['user_profile']['primary_key'] = 'upro_id';
	$config['database']['custom']['user_profile']['foreign_key'] = 'upro_uacc_fk';
	$config['database']['custom']['user_profile']['join'] = $config['database']['dbprefix'].'user_profiles.upro_uacc_fk';
	$config['database']['custom']['user_profile']['custom_columns'] = array(
		'upro_image', 'upro_company','upro_first_name','upro_last_name',
		'upro_phone','upro_newsletter','upro_pass','upro_subadmin','upro_creater_id','upro_direct_order',
		'upro_department', 'upro_profession', 'upro_approval_acc','unique_url'
	);
	 ...
	 * Note: This table and all included fields can be expanded upon or removed completely.
	*/ 
	$config['database']['custom']['user_address']['table'] = $config['database']['dbprefix'].'user_address';
	$config['database']['custom']['user_address']['primary_key'] = 'uadd_id';
	$config['database']['custom']['user_address']['foreign_key'] = 'uadd_uacc_fk';
	$config['database']['custom']['user_address']['join'] = $config['database']['dbprefix'].'user_address.uadd_uacc_fk';
	...
	*/ 
	$config['sessions']['name'] = 'flexi_auth_admin';
	...
	*/
	...
	$config['sessions']['user_privileges'] = 'user_privileges';
	$config['sessions']['group_privileges'] = 'group_privileges';	
	$config['sessions']['privileges'] = 'privileges';
	$config['sessions']['custom_user_data'] = 'custom_user_data';
	...
	*/
	...
	/**
	 * Set whether an email shoot on new user create or not.
	 * @param: bool
	 *
	*/
	$config['settings']['shoot_email_on_account_create'] = TRUE;	
	/**
	...
	*/
	...
	$config['email']['site_title'] = "Kilimanjaro";
	
	// Reply email shown as 'from' header on emails.
	$config['email']['reply_email'] = "info@Kilimanjaro.com";
