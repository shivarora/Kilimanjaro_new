                                            ...
                                            <tbody style="font-weight: bold; line-height: 22px;">
                                                <tr>
                                                    <td style="padding: 10px 15px;">
                                                            ...
                                                            <?php echo $order_shipping['address_1'] ?>,<br>
                                                                <?php echo $order_shipping['city'] ?>,<br>
                                                                    <?php echo $order_shipping['county'] ?>, <?php echo $order_shipping['postcode'] ?> <br>
                                                                        <?php echo $order_shipping['country'] ?> <br>
                                                                            T: <?php echo $order_shipping['phone'] ?> <br>
                                                                                <?php echo $order_shipping['order_email'] ?>
                                                                                </td>
                                                                                <td>
                                                                                    
                                                                                        <?php echo $order_shipping['billing_address1'] ?>,<br>
                                                                                            <?php echo $order_shipping['billing_city'] ?>,<br>
                                                                                                <?php echo $order_shipping['billing_county'] ?>, <?php echo $order_shipping['postcode'] ?>  <br>
                                                                                                    <?php echo $order_shipping['billing_country'] ?> <br>
                                                                                                        T: <?php echo $order_shipping['billing_phone'] ?> <br>
                                                                                                        </td>
                                                                                                        </tr>
                                                                                                        </tbody>
                                                                                                    </table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="40%" style="vertical-align: top;padding-bottom: 10px;padding-top: 10px;"> 
                                                                        <table style="width: 100%">
                                                                            ...
                                                                            <td style="text-align: right;">
                                                                            £ <?php echo $order_details['shipping_charges'] ?>
                                                                            </td>
                                                                            </tr>
                                                                            </tbody>
                                                        </table>
                                                    ...
                                                    <td width="40%" style="border:1px solid #a9a9a9;border-bottom:none; border-left:none;border-right:none;padding-top: 10px;padding-bottom: 10px;"> 
                                                        <table>
                                                            <tbody><tr>
                                                                ...
                                                                <td style="text-align: right;">
                                                                    <strong>£ <?php echo $order_details['order_total'] + $order_details['shipping_charges']?></strong>
