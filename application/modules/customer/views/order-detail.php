                                        ...
                                        <tfoot class="pull-right">
                                            <tr>
                                                <td colspan="1" class="a-right" style="">
                                                    <h4 style="padding-right: 10px;" class="product-name"> Subtotal (Excl TAX): <span class="price product-name"><?php echo MCC_CURRENCY_SYMBOL . round(($order['order_total'] * (100 / (100 + $order['vat']))), 2) ?></span> </h4>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="1" class="a-right" style="">
                                                    <h4 style="padding-right: 10px;" class="product-name"> TAX: <span class="price product-name"><?php echo $order['vat'] . '%' ?></span> </h4>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="1" class="a-right" style="">
                                                    <h4 style="padding-right: 10px;" class="product-name"> Subtotal (Incl TAX): <span class="price product-name"><?php echo MCC_CURRENCY_SYMBOL . $order['order_total'] ?></span> </h4>
                                                </td>
                                            </tr>
                                        </tfoot>
                                    </table>
