...
class Payments_backend extends Front_Controller 
{
       ...
       if(count($all_Orders) > 0){
        ...
        foreach ($all_Orders as $key => $value) {
            ...
            # code...
                    ...
                    'uadd_recipient'   => $orderDetail['upro_first_name']. " " .$orderDetail['upro_last_name'],
                    'uadd_phone'       => $orderDetail['phone'],
                    'uadd_address_01'  => $orderDetail['address_1'],
                    'uadd_address_02'  => $orderDetail['address_2'],
                    'uadd_city'        => $orderDetail['city'],
                    'uadd_post_code'   => $orderDetail['postcode'],
                    'uadd_county'      => $orderDetail['county']
                    ]);
